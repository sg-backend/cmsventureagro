...
import {
  ...
  CProgress,
  CRow,
  CCallout,CWidgetProgressIcon,CCardGroup, CContainer,
  CModal,
  CModalBody,
  CModalFooter,
...
const Dashboard = () => {
  ...
  return (
    <>
            ...
            <CRow>
              <CCol xs="3" md="3" lg="12" style={{ paddingLeft:'7%'}}>
              <CButton color="warning" onClick={() => setWarning(!warning)} className="mr-1">Upgrade</CButton>
                <CModal 
                    show={warning} 
                  ...
                  >
                    ...
                    <CFormGroup>
                        ...
                        <CInput id="name" type="text" placeholder="Enter your name *" required />
                      </CFormGroup>
                      <CFormGroup>
                        <CLabel htmlFor="number">Mobile No</CLabel>
                        <CInput id="mobile" type="number" placeholder="Enter your Mobile No *"required />
                      </CFormGroup>
                      <CFormGroup>
                        <CLabel htmlFor="email">Company</CLabel>
    ...
    <CContainer style={{paddingLeft:'5%',paddingTop:'5%'}}>
      <CRow xs="1" sm="1" md="2" style={{ textAlign:'center'}}>
        <CCol md="6">
        <CWidgetProgressIcon
      ...
      <CContainer style={{paddingLeft:'5%'}}>
      <CRow xs="1" sm="1" md="2" style={{textAlign:'center'}}>
        <CCol md="6">
        <CWidgetProgressIcon
            header="New Products"
